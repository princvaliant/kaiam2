Settings = {
    ...
    partNumbers: {
        XQX2100: {color: '#4661EE', device: '40GB', product: 'XQX21'},
        XQX2103: {color: '#1BCDD1', device: '40GB', product: 'XQX21'},
        XQX2104: {color: '#8FAABB', device: '40GB', product: 'XQX21'},
        XQX2105: {color: '#B08BEB', device: '40GB', product: 'XQX21'},
        XQX2195: {color: '#C08BEB', device: '40GB', product: 'XQX21'},
        XQX2401: {color: '#738FAA', device: '40GB', product: 'XQX24'},
        XQX2402: {color: '#EC5657', device: '40GB', product: 'XQX24'},
        XQX2406: {color: '#EE1657', device: '40GB', product: 'XQX24'},
        XQX2408: {color: '#EE1657', device: '40GB', product: 'XQX24'},
        XQX2501: {color: '#A38FAA', device: '40GB', product: 'XQX25'},
        XQX2502: {color: '#EB8CC6', device: '40GB', product: 'XQX25'},
        XQX2503: {color: '#F5A52A', device: '40GB', product: 'XQX25'},
        XQX2508: {color: '#F5A52A', device: '40GB', product: 'XQX25'},
        XQX2595: {color: '#65A52A', device: '40GB', product: 'XQX25'},
        XQX3202: {color: '#068F7A', device: '40GB', product: 'XQX32'},
        XQX3205: {color: '#038FAA', device: '40GB', product: 'XQX32'},
        XQX3201: {color: '#438FAA', device: '40GB', product: 'XQX32'},
        XQX3208: {color: '#438FAA', device: '40GB', product: 'XQX32'},
        XQX3295: {color: '#C08BEB', device: '40GB', product: 'XQX32'},
        XQX4000: {color: '#238FAA', device: '100GB', product: 'XQX40', primary: true, calc: true},
        XQX4001: {color: '#538FAA', device: '100GB', product: 'XQX40', primary: true},
        XQX4002: {color: '#538F3A', device: '100GB', product: 'XQX40', primary: true},
        XQX4007: {color: '#238F3A', device: '100GB', product: 'XQX40', primary: true},
        XQX4008: {color: '#738FAA', device: '100GB', product: 'XQX40', primary: true},
        XQX4009: {color: '#938FAA', device: '100GB', product: 'XQX40', primary: true},
        XQX4010: {color: '#233FAA', device: '100GB', product: 'XQX40', primary: true},
        XQX4095: {color: '#433FAA', device: '100GB', product: 'XQX40', primary: true},
        XQX4100: {color: '#A38FAA', device: '100GB', product: 'XQX41', primary: true, calc: true},
        XQX4300: {color: '#138F1A', device: '100GB', product: 'XQX43', primary: true, calc: true},
        XQX4302: {color: '#438F4A', device: '100GB', product: 'XQX43', primary: true},
        XQX4400: {color: '#23821A', device: '100GB', product: 'XQX44', primary: true, calc: true},
        XQXRMA4000: {color: '#338FAA', device: '100GB', product: 'XQXRMA40', primary: true},
        XQXGRR4000: {color: '#138FAA', device: '100GB', product: 'XQXGRR40', primary: true},
        XQXENG4000: {color: '#238FAA', device: '100GB', product: 'XQXENG40', primary: true},
        XQXENG4100: {color: '#338FAA', device: '100GB', product: 'XQXENG41', primary: true},
        XQX5000: {color: '#0033FF', device: '100GB', product: 'XQX50', primary: true, calc: true},
        XQX5003: {color: '#DE03FF', device: '100GB', product: 'XQX50', primary: true},
        XQX5100: {color: '#50133F', device: '100GB', product: 'XQX51', primary: true, calc: true},
        XQX5300: {color: '#70133F', device: '100GB', product: 'XQX53', primary: true, calc: true},
        XQX5400: {color: '#90133F', device: '100GB', product: 'XQX54', primary: true, calc: true},
        XQX5900: {color: '#00133F', device: '100GB', product: 'XQX59', primary: true, calc: true}
    },
    ...
    getPartNumbersForDevice: function (device) {
        ...
        _.each(_.keys(Settings.partNumbers), (key) => {
            if (Settings.partNumbers[key].device === device || device === '-all-') {
                res.push(key);
            }
        });
        return res;
