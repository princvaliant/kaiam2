/**
 * @preserve CanvasJS HTML5 & JavaScript Charts - v1.9.0 GA - http://canvasjs.com/
...
(function () {
    ...
    function addWatermark(chart) {
        ...
        ctx.font = fontSize + "px Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif";
        ctx.fillStyle = "grey";
        ctx.fillText("Trial Version", 2, chart.height - fontSize - 2);
    }
    ...
    function Chart(containerId, options, publicChartReference) {
        ...
        if (!this._creditLink) {
            ...
            this._creditLink.setAttribute("style", "outline:none;margin:0px;position:absolute;right:2px;top:" + (this.height - 13) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif");
    ...
    CanvasJS.Chart.version = "v1.9.0 GA";
