...
controller('ExportdataController', [
  ...
  '$translate', '$translatePartialLoader', '$timeout', 'ExportDataService', ($scope, $rootScope, $log, $state, $mdToast, $cookies, $meteor, $mdDialog, $location, $window,
    ...
    $scope.exportClicked = function() {
      ...
      $meteor.call('exportData', $scope.serial, [$scope.testType], $scope.partNumber, $scope.dateFrom, $scope.dateTo, $scope.errorStatus).then(
        function(data) {
          if (data.length === 0) {
